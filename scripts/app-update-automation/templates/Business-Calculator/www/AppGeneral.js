...
applicationName = "Business Calculator";
...
function showPrintDialog(){
    ...
    cordova.plugins.printer.print(html, 'BusinessCalculator.html', function () {
...
function exportAsCsv(){
    ...
    window.requestFileSystem(LocalFileSystem.PERSISTENT, 0, function(fileSystem) {
                             ...
                             //alert("fs");
                             fileSystem.root.getFile("BusinessCalculator.csv", {create: true}, function(entry) {
                                                     var fileEntry = entry;
                                                     console.log(entry);
...
item.init=function(){
    ...
    $.ajax({
           ...
           productList.push({"Feature": "10Pdf","Id": "2016bcalc10Pdf","Purchase":"No","Consumed":0,"Own":0 });
           productList.push({"Feature": "25Pdf","Id": "2016bcalc25Pdf","Purchase":"No","Consumed":0,"Own":0 });
           productList.push({"Feature": "50Pdf","Id": "2016bcalc50Pdf","Purchase":"No","Consumed":0,"Own":0 });
           productList.push({"Feature": "100Pdf","Id": "2016bcalc100Pdf","Purchase":"No","Consumed":0,"Own":0});
           productList.push({"Feature": "fb-tw-sms-whatsapp","Id": "2016bcalc10share","Purchase":"No","Consumed":0,"Own":0});
           productList.push({"Feature": "email-print-save","Id": "2016bcalcSavePrintEmail","Purchase":"Yes","Consumed":0,"Own":1});
           productList.push({"Feature": "pdf-ibooks","Id": "2016bcalcSavePdf","Purchase":"No","Consumed":0,"Own":0})
           productList.push({"Feature": "email-second-print-save","Id": "2016bcalc500SavePrintEmail","Purchase":"No","Consumed":0,"Own":0});/*** 500 & 1000 times Save as, Print and Email ***/
           productList.push({"Feature": "email-third-print-save","Id": "2016bcalc1000SavePrintEmail","Purchase":"No","Consumed":0,"Own":0});
...
var IAP = {
list: [ "2016bcalc10Pdf", "2016bcalc25Pdf", "2016bcalc50Pdf","2016bcalc100Pdf","2016bcalc10share" ,"2016bcalcCloud" ,"2016bcalcSavePrintEmail" , "2016bcalcSavePdf" , "2016bcalc500SavePrintEmail", "2016bcalc1000SavePrintEmail"]
};
...
item.successCallback=function(productId){
    ...
    switch(productId){
        ...
        case "2016bcalcSavePrintEmail":  /*** 500 & 1000 times Save as, Print and Email ***/
            var left = 0;
            ...
            break;
        case "2016bcalc500SavePrintEmail":  /*** 500 & 1000 times Save as, Print and Email ***/
            ...
            break;
        case "2016bcalc1000SavePrintEmail":  /*** 500 & 1000 times Save as, Print and Email ***/
            var left = 0;
            if(products[5].Purchase == "Yes"){
                left = parseInt(products[5].Own) - parseInt(products[5].Consumed);
                products[5].Consumed = 0;
...
function cloudInappSuccess(){
    ...
    $.ajax({
           ...
           data: {action:"purchase",appname:"Business Calculator"},
           dataType: 'json',
           success: function(response) {
...
function setCloudRestoreItems(products){
    ...
    $.ajax({
           type: 'POST',
           url: 'http://aspiringapps.com/restore',
           data: {content:products,action:"inapp",appname:"Business Calculator"},
           dataType: 'json',
           success: function(response) {
           ...
           //showToast("Please Login to access Business Calculator on web");
...
function updateShareItem(){
    ...
    var itemConsumed;
    for(i in products){
        if(products[i].Id == "2016bcalc10share")
            itemConsumed = i;
    }
...
function checkBeforeSave(file){
    ...
    if(products[0].Purchase == "Yes"){
        ...
        navigator.notification.alert("Save as exhausted.Kindly purchase by clicking on the Purchase Tab",null,"Business Calculator Widget");
...
function saveToWeb(file){
    ...
    var interval = setInterval(function(){
                               ...
                               request(messages, function(result){
                                       ...
                                       message.type="POST";
                                       message.format = 'json';
                                       message.data={action:"savefile",fname:fname,data:val1,appname:"Business Calculator"};
...
function updateCloudInapp(){
    ...
    message.type="POST";
    message.format = 'json';
    message.data={action:"update",appname:"Business Calculator"};
...
function showFeedback(){
    cordova.require('emailcomposer.EmailComposer').show({
                                                        ...
                                                        cc: '',
                                                        bcc: '',
                                                        subject: 'Business Calculator: Please share your feedback',
                                                        body: '',
                                                        isHtml: true,
                                                        onSuccess: function (winParam) {
                                                        console.log('EmailComposer onSuccess - return code ' + winParam.toString());
...
function refer(){
    ...
    var onConfirm = function(buttonIndex){
        if(buttonIndex == 4) return;
            ...
            window.plugins.socialsharing.shareViaFacebook('Business Calculator using Business Calculator', 'www/img/bi.png' /* img */, 'https://itunes.apple.com/us/app/medication-log/id894930232?ls=1&mt=8#' /* url */, function() {
                                                          console.log('share ok');
                                                          },
                                                          function(errormsg){console.log(errormsg)});
            ...
            window.plugins.socialsharing.shareViaTwitter('Business Calculator using Business Calculator','www/img/bi.png','https://itunes.apple.com/us/app/medication-log/id894930232?ls=1&mt=8#');
        }
    ...
    navigator.notification.confirm(
                                   'Refer Business Calculator via', // message
                                   onConfirm,  // callback to invoke with index of button pressed
...
function savePDF(){
    ...
    window.html2pdf.create(
                           ""+content+"",
                           "~/Documents/BusinessCalculator.pdf", // on iOS,
...
function checkBeforeUse(feature,name){
    ...
    if(feature == "email"){
        ...
        cordova.require('emailcomposer.EmailComposer').show({
                                                            ...
                                                            cc: '',
                                                            bcc: '',
                                                            subject: 'Business Calculator Workbook',
                                                            body: content,
                                                            isHtml: true,
                                                            attachments: [{
                                                                          mimeType: 'text/html',
...
document.addEventListener("deviceready", function(){
                          ...
                          for(i in products){
                          if(products[i].Id == "2016bcalcSavePrintEmail"){
                          console.log("saveEmail present");
                          saveEmail=true;
                          }
                          if(products[i].Id == "2016bcalcSavePdf"){
                          console.log("savePdf present");
                          savePdf=true;
                          }
                          if(products[i].Id == "2016bcalc500SavePrintEmail"){
                          console.log("secondSaveEmail present");
                          secondSaveEmail=true;
                          }
                          if(products[i].Id == "2016bcalc1000SavePrintEmail"){
                          ...
                          if(!saveEmail){
                          products.push({"Feature": "email-print-save","Id": "2016bcalcSavePrintEmail","Purchase":"Yes","Consumed":0,"Own":10});
                          ...
                          if(!savePdf){
                          products.push({"Feature": "pdf-ibooks","Id": "2016bcalcSavePdf","Purchase":"No","Consumed":0,"Own":0});
                          console.log("new "+JSON.stringify(products));
                          window.localStorage.setItem("inapplocal",  JSON.stringify(products));
                          setCloudRestoreItems(JSON.stringify(products));
                          }
                          ...
                          if(!secondSaveEmail){
                          products.push({"Feature": "email-second-print-save","Id": "2016bcalc500SavePrintEmail","Purchase":"No","Consumed":0,"Own":0});
                          console.log("new "+JSON.stringify(products));
                          window.localStorage.setItem("inapplocal",  JSON.stringify(products));
                          setCloudRestoreItems(JSON.stringify(products));
                          }
                          ...
                          if(!thirdSaveEmail){
                          products.push({"Feature": "email-third-print-save","Id": "2016bcalc1000SavePrintEmail","Purchase":"No","Consumed":0,"Own":0});
                          console.log("new "+JSON.stringify(products));
                          window.localStorage.setItem("inapplocal",  JSON.stringify(products));
                          setCloudRestoreItems(JSON.stringify(products));
                          }
