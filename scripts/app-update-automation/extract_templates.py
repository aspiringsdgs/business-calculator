...
html_path = os.path.join(script_dir, 'templates/Medical-Suite/www/templates/tab-home.html')
...
medical_footers = [
    {"name": "Information", "index": 1, "isActive": True},
    {"name": "Check-up", "index": 2, "isActive": True},
    {"name": "Tests", "index": 3, "isActive": True},
    {"name": "Drug", "index": 4, "isActive": True},
    {"name": "Log 1", "index": 5, "isActive": True},
    {"name": "Log 2", "index": 6, "isActive": True},
    {"name": "Log 3", "index": 7, "isActive": True}
]

tablet_template = {
    "mainSheet": "sheet1",
    "msc": json_tab,
    "footers": medical_footers,
    "appMapping": {}
}
