                        ...
                        <div className="settings-card">
                            <div className="settings-row">
                                <div className="settings-info">
                                    ...
                                    <p className="settings-card-desc">Change the display currency for your business calculations.</p>
                                </div>
                        ...
                        <div className="settings-card">
                            <div className="settings-row">
                                <div className="settings-info">
                                    ...
                                    <p className="settings-card-desc">Wipe all local calculation files, custom templates, and configuration settings completely.</p>
                                </div>
                                <div className="settings-action">
                                    <IonButton
                                        className="reset-btn"
                    ...
                    <div className="settings-group">
                        ...
                        <div className="settings-card" style={{ padding: '16px 20px' }}>
                            <div className="info-row">
                                ...
                                <span className="info-value">Business Calculator</span>
                            </div>
                            <div className="info-row">
                                <span className="info-label">Marketing Version</span>
                                <span className="info-value">6.0</span>
                            </div>
                            <div className="info-row">
