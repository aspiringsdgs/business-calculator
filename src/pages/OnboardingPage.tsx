                        ...
                        >
                            ...
                            <div className="step-header">
                                ...
                                >
                                 ...
                                 <h1 className="step-title">Welcome to Business Calculator</h1>
                                <p className="step-subtitle">Compute present value, monthly loan payments, gross margins, inventory turnover, markups, and markdowns instantly offline.</p>
                            </div>
                                ...
                                <div className="onboarding-welcome">
                                    <div className="welcome-features">
                                        <div className="feature-item">
                                            ...
                                            <span>Compute complex financial and marketing metrics instantly offline</span>
                                        </div>
                                        <div className="feature-item">
                                            <IonIcon icon={checkmarkCircle} color="success" />
                                            <span>Analyze interest rates, gross sales, cost of goods sold, and markups</span>
                                        </div>
                                        <div className="feature-item">
                                            <IonIcon icon={checkmarkCircle} color="success" />
                                            <span>Generate professional PDF reports and share spreadsheets directly</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
